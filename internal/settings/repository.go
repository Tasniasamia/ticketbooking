...
// Get returns the single settings row (first one). Returns gorm.ErrRecordNotFound if none.
...
func (r *repository) Create(s *Setting) error {
	return r.db.Create(s).Error
}

func (r *repository) Update(s *Setting) error {
